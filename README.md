...
**Blog app** This is a blog app built with ruby on rails.
...
```sh
  cd my-folder
  git clone https://github.com/toyman640/blog.git
```
...
Feel free to check the [issues page](https://github.com/toyman640/blog/issues).
